import React from 'react'
 ...
 const contact = () => {
  ...
  return (
    <div  className='min-h-screen' style={{ backgroundImage: 'url("/eco-back.jpg")', backgroundSize: 'cover', backgroundPosition: 'center' }}>
        <>
  {/* Contact Us */}
  <div className="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
    <div className="max-w-xl mx-auto">
      <div className="text-center">
        <h1 className="text-3xl underline font-bold text-gray-800 sm:text-4xl dark:text-white">
          Contact us
        </h1>
    ...
    <div className="mt-12 max-w-lg mx-auto bg-green-200 ">
      {/* Card */}
