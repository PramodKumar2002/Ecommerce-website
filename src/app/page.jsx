          ...
          <div className="grid md:grid-cols-2 gap-4 md:gap-8 xl:gap-20 md:items-center">
            <div>
              <h1 className="block text-3xl font-bold text-gray-800 sm:text-4xl lg:text-6xl lg:leading-tight dark:text-white">
                Start your journey with <span className="text-blue-600">Eco-Friendl Product MarketPlace</span>
              </h1>
              <p className="mt-3 text-lg text-gray-800 dark:text-neutral-400">
                Switch to eco-friendly products—smart choices for a sustainable future! From reusable essentials to biodegradable solutions, eco-friendly products are not just better for the planet but also reflect a modern, conscious lifestyle.
              </p>
              {/* Buttons */}
            ...
            <div className="relative ms-4">
              <img
                ...
                src="DALL·E 2024-12-03 11.28.02 - A vibrant eco-friendly marketplace featuring a variety of eco-friendly products like reusable bottles, organic produce, bamboo utensils, handmade soap.webp"
                alt="Hero Image"
              />
          ...
          <div className="mt-5 sm:mt-12 grid gap-y-2 sm:gap-y-0 sm:flex sm:justify-between sm:items-center">
            <div className="flex justify-between items-center">
              <p className="text-sm text-gray-400 dark:text-neutral-400">
                © 2024 EcoMarketplace | Privacy Policy | Terms of Service
              </p>
            </div>
            {/* End Col */}
            {/* Social Brands */}
